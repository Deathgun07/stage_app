...
<body>
    <section class="section login">
        ...
        <div class="item">
            ...
            <h1 class="text-title" id="titre">Bienvenu sur iStage</h1>
            <p class="baseline">Connectez-vous pour accéder à votre espace personnel et découvrir toutes les fonctionnalités de gestion de stages</p>
            <form action="" method="post" class="form">
                <div class="input">
                    <input type="text" placeholder="<?php if(isset($_GET['other']) AND $_GET['other'] == "on"){?>Entrez votre email<?php }else {?>Entrez votre matricule etudiant<?php } ?>" name="matricule" required>
                </div>
                <?php  
                
                if(isset($_GET['other']) AND $_GET['other'] == "on"){
                    ?>
                        <div class="input">
            ...
            <?php  
                ...
                if(isset($_GET['other']) AND $_GET['other'] == "on"){
                    ?>
                    <div class="">Je suis un etudiant, <a href="index.php">Se connecter autrement?</a></div>
                    <?php
                }else {
                    ?>
                    <div class="">Je ne suis pas un etudiant, <a href="index.php?other=on">Se connecter autrement?</a></div>
                    <?php
                }
                
            ?>
            <p class="subtext copy" id="copy">Copyright2024 created by IFSM</p>
        </div>
    </section>
</body>
</html>