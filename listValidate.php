    ...
    <div class="navbar">
        ...
        <div class="content">
            <div class="item">
                ...
                if (isset($_GET['success']) && isset($_GET['idEtudiant'])) {

                    $checkE = $bd->prepare('SELECT * FROM etudiant WHERE id = ?');
                    $checkE->execute(array($_GET['idEtudiant']));

                    $user_etudiant = $checkE->fetch();

                    ?>
                        <div class="msg">La demande de <?= $user_etudiant['prenom'] ?> <?= $user_etudiant['nom'] ?> a été bien validée !</div>
                    <?php
                }
                            ...
                            <?php
                                ...
                                if ($checkCandidates->rowCount() > 0) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="./validate.php?id=<?= $etudiant['id'] ?> ">Valider la demande</a>
                                        </td>
