...
<body>
    <section class="home section">
        ...
        <div class="text">
                ...
                <h2><span style="color: var(--blue); text-transform: capitalize;"><?= $_SESSION['prenom'] ?> <?= $_SESSION['nom'] ?></span></h2>
            </div>
            <div id="statut"><?= $_SESSION['statut'] ?><?php echo ($_SESSION['statut'] == 'Etudiant(e)') ? '_'.$_SESSION['matricule'] : ''; ?></div>
            <div class="profile">
        ...
        <div class="menu-lateral">
            ...
            <h2 class="welcome">Bienvenu à vous <span style="color: var(--blue); text-transform: capitalize;">Flora Kouassi</span></h2>
            <ul>
                <li>
                    <a href="./home.php">
                ...
                <?php 
                    ...
                    if ( $_SESSION['statut'] == "Administrateur" ) {
                        ?>
                            <li>
                                <a href="./list.php?statut=en_cours">
                            ...
                            <li>
                                <a href="./list.php?statut=en_attente">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-patch-exclamation" viewBox="0 0 16 16">
                                        <path d="M7.001 11a1 1 0 1 1 2 0 1 1 0 0 1-2 0zM7.1 4.995a.905.905 0 1 1 1.8 0l-.35 3.507a.553.553 0 0 1-1.1 0z"/>
                                        <path d="m10.273 2.513-.921-.944.715-.698.622.637.89-.011a2.89 2.89 0 0 1 2.924 2.924l-.01.89.636.622a2.89 2.89 0 0 1 0 4.134l-.637.622.011.89a2.89 2.89 0 0 1-2.924 2.924l-.89-.01-.622.636a2.89 2.89 0 0 1-4.134 0l-.622-.637-.89.011a2.89 2.89 0 0 1-2.924-2.924l.01-.89-.636-.622a2.89 2.89 0 0 1 0-4.134l.637-.622-.011-.89a2.89 2.89 0 0 1 2.924-2.924l.89.01.622-.636a2.89 2.89 0 0 1 4.134 0l-.715.698a1.89 1.89 0 0 0-2.704 0l-.92.944-1.32-.016a1.89 1.89 0 0 0-1.911 1.912l.016 1.318-.944.921a1.89 1.89 0 0 0 0 2.704l.944.92-.016 1.32a1.89 1.89 0 0 0 1.912 1.911l1.318-.016.921.944a1.89 1.89 0 0 0 2.704 0l.92-.944 1.32.016a1.89 1.89 0 0 0 1.911-1.912l-.016-1.318.944-.921a1.89 1.89 0 0 0 0-2.704l-.944-.92.016-1.32a1.89 1.89 0 0 0-1.912-1.911l-1.318.016z"/>
                                    </svg>
                            ...
                            <li>
                                <a href="./list.php?statut=suspendu">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-patch-exclamation" viewBox="0 0 16 16">
                                        <path d="M7.001 11a1 1 0 1 1 2 0 1 1 0 0 1-2 0zM7.1 4.995a.905.905 0 1 1 1.8 0l-.35 3.507a.553.553 0 0 1-1.1 0z"/>
                                        <path d="m10.273 2.513-.921-.944.715-.698.622.637.89-.011a2.89 2.89 0 0 1 2.924 2.924l-.01.89.636.622a2.89 2.89 0 0 1 0 4.134l-.637.622.011.89a2.89 2.89 0 0 1-2.924 2.924l-.89-.01-.622.636a2.89 2.89 0 0 1-4.134 0l-.622-.637-.89.011a2.89 2.89 0 0 1-2.924-2.924l.01-.89-.636-.622a2.89 2.89 0 0 1 0-4.134l.637-.622-.011-.89a2.89 2.89 0 0 1 2.924-2.924l.89.01.622-.636a2.89 2.89 0 0 1 4.134 0l-.715.698a1.89 1.89 0 0 0-2.704 0l-.92.944-1.32-.016a1.89 1.89 0 0 0-1.911 1.912l.016 1.318-.944.921a1.89 1.89 0 0 0 0 2.704l.944.92-.016 1.32a1.89 1.89 0 0 0 1.912 1.911l1.318-.016.921.944a1.89 1.89 0 0 0 2.704 0l.92-.944 1.32.016a1.89 1.89 0 0 0 1.911-1.912l-.016-1.318.944-.921a1.89 1.89 0 0 0 0-2.704l-.944-.92.016-1.32a1.89 1.89 0 0 0-1.912-1.911l-1.318.016z"/>
                                    </svg>
        ...
        <div class="content">
            <div class="item">
                ...
                <div class="grid-container">
                    <div class="grid-item">
                        <img src="./upload/photo/offre.png" alt="" class="icon">
                        <h2 class="offre_title">STAGE DEVELOPPEUR</h2>
                        <br>
                        <p><strong><span style="color: var(--blue);">Ent:</span> Ecosarl, <span style="color: var(--blue);">Type de contrat:</span> Stage</strong> <br> 2024-12-26</p>
                        <br>
                        <p class="desc">
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. 
                            Deleniti necessitatibus impedit temporibus assumenda 
                            ullam est soluta ipsum sunt ducimus nesciunt.
                        </p>
                        <br>
                        <a href="" class="btn" style="width: 100%;font-size: 12px;">Voir plus</a>
                    </div>
                    <div class="grid-item">
                        <img src="./upload/photo/offre.png" alt="" class="icon">
                        <h2 class="offre_title" style="text-align: center;">STAGE RESSOURCE HUMAINE</h2>
                        <br>
                        <p><strong><span style="color: var(--blue);">Ent:</span> Ecosarl, <span style="color: var(--blue);">Type de contrat:</span> Stage</strong> <br> 2024-12-26</p>
                        <br>
                        <p class="desc">
                    ...
                    <div class="grid-item">
                        <img src="./upload/photo/offre.png" alt="" class="icon">
                        <h2 class="offre_title">Assistante de direction</h2>
                        <br>
                        <p><strong><span style="color: var(--blue);">Ent:</span> Ecosarl, <span style="color: var(--blue);">Type de contrat:</span> Stage</strong> <br> 2024-12-26</p>
                        <br>
                        <p class="desc">
