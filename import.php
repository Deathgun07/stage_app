...
<style>  
    ...
    .import .btn:active, .import .btn:focus {
        font-size: 14px; 
    }
    .btn:hover{
        font-size: 12px; 
...
<body>
    <section class="home section import">
        <div class="navbar">
            <div class="text">
                ...
                <h2>Bienvenu à vous <span style="color: var(--blue); text-transform: capitalize;"><?= $_SESSION['prenom'] ?> <?= $_SESSION['nom'] ?></span></h2>
            </div>
            <div id="statut"><?= $_SESSION['statut'] ?></div>
            <div class="profile">
        ...
        <div class="menu-lateral">
            ...
            <h2 class="welcome">Bienvenu à vous <span style="color: var(--blue); text-transform: capitalize;"><?= $_SESSION['prenom'] ?> <?= $_SESSION['nom'] ?></span></h2>
            <ul>
                <li>
                    <a href="./home.php">
                ...
                <?php 
                    ...
                    if ( $_SESSION['statut'] == "Administrateur" ) {
                        ?>
                            <li>
                                <a href="./list.php?statut=en_cours" id="<?php if (isset($_GET['statut'])) { if ($_GET['statut'] == 'en_cours') { echo 'active';}} ?>">
        ...
        <div class="content">
            <div class="item">
                <div class="label">
                    <div class="text">
                        <H1>IMPORTATION DES DONNEES ETUDIANTS</H1>
                        <p>
                ...
                <?php 
                    ...
                    if (isset($errormsg) OR isset($success)) {
                        if (isset($errormsg)) {
                            ?>
                                <div class="error">
                                    <?= $errormsg ?>
                ...
                ?>
                <form action="" method="post" enctype="multipart/form-data" class="import">
                    <div class="row">
                        <select class="col" name="section" required>
                            <option value="0">Veuillez selectionez la section</option>
                            <?php
                                while ($section = $selectSection->fetch()) {
                                    ?>
                        ...
                        <select class="col" name="classe" required>
                    ...
                    <input type="file" name="file_input" id="file_input" class="col" required>
                    <button type="submit" class="btn" id="importate" name="import">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-download" viewBox="0 0 16 16">
                            <path d="M.5 9.9a.5.5 0 0 1 .5.5v2.5a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1v-2.5a.5.5 0 0 1 1 0v2.5a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2v-2.5a.5.5 0 0 1 .5-.5"/>
                            <path d="M7.646 11.854a.5.5 0 0 0 .708 0l3-3a.5.5 0 0 0-.708-.708L8.5 10.293V1.5a.5.5 0 0 0-1 0v8.793L5.354 8.146a.5.5 0 1 0-.708.708l3 3z"/>
                        </svg>
    ...
    <script>
        const button = document.querySelector('#importate');
