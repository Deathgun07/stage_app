...
$candidates = $checkCandidates->fetch();
        ...
        <div class="content">
            <div class="item">
                ...
                if (isset($_GET['success'])) {
                    ...
                    ?>
                        <div class="msg">Votre demande a été bien modifiée !</div>
                    <?php
                }
                        ...
                        <tr>
                            <?php
                                ...
                                if ($checkCandidates->rowCount() > 0) {
                                    ...
                                    ?>
                                        <td id="statuts">
                                            <p>Demande de stage effectuée le <?= $candidates['date'] ?></p> <span style="display:block; padding: 5px 10px; background: <?php if ($candidates['statut'] == 'suspendu') { echo "#ff0000"; } else { echo "var(--blue)" ; } ?>; color: var(--white); width: fit-content; margin-top: 5px;"><?= $candidates['statut'] ?></span>
                                        </td>
                                        <td>
                                            <a href="./sheet.php" class="btn">Voir plus</a>
                                        </td>
                                    <?php
                                }else {
                                    ?>
                                        ...
                                        <td style="text-align: end;" class="btn">
                                            <a href="form.php?new=on">Remplir le formulaire de stage</a>
                                        </td>
                                    <?php
                                }
