...
<head>
    ...
    <title>Bienvenu <?= $_SESSION['prenom'] ?></title>
</head>
<style>
    .home .content .item .details .info:nth-child(1){
        position: relative;
        background: url(<?= $_etudiant['photo'] ?>) no-repeat;
    ...
    <section class="home section">
        ...
        <div class="content">
            <div class="banner">
                <div class="banner-text">
                    ...
                    <?php 
                        ...
                        if ( $_SESSION['statut'] == "Etudiant(e)" && $checkCandidates->rowCount() == 0 ) {
                            ?>
                                <a href="./form.php?new=on">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil" viewBox="0 0 16 16">
                                        <path d="M12.146.146a.5.5 0 0 1 .708 0l3 3a.5.5 0 0 1 0 .708l-10 10a.5.5 0 0 1-.168.11l-5 2a.5.5 0 0 1-.65-.65l2-5a.5.5 0 0 1 .11-.168l10-10zM11.207 2.5 13.5 4.793 14.793 3.5 12.5 1.207zm1.586 3L10.5 3.207 4 9.707V10h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.293zm-9.761 5.175-.106.106-1.528 3.821 3.821-1.528.106-.106A.5.5 0 0 1 5 12.5V12h-.5a.5.5 0 0 1-.5-.5V11h-.5a.5.5 0 0 1-.468-.325z"/>
                                    </svg>
                                    Remplir le formulaire de stage
                                </a>
                            <?php
                        }
            ...
            <div class="item">
                ...
                <div class="details">
                    <div class="info" >
                        <img src="<?= $etudiant['photo'] ?>" alt="" id="photo">
                    </div>
                    <div class="info">
                        <?php 
                        ...
                        <table id="table">
                            <tr>
                                <td>
                                    ...
                                    <div class="details-info">
                                        <p><?= $etudiant['date'] ?></p>
                                        <h2>Date et lieu de naissance</h2>
                                    </div>
                                </td>
                                <td>
                                    <div class="details-info">
                                    ...
                                    <div class="details-info">
                                        <p>Admissible au bts</p>
                                        <h2>Descision de fin d'année</h2>
                                    </div>
                                </td>
                                <td>
                                    <?php 
                                    ...
                                    <div class="details-info">
                                        ...
                                        <?php 
                                            ...
                                            else if ($etudiant['solde'] == 0) {
                                                echo "Soldé";
                                            }else {

                                                echo $etudiant['solde'].' FCFA'; 
                                            }
