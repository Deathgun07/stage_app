...
require('./php/validateAction.php');
...
if ($_SESSION['statut'] == 'Administrateur') {
    ...
    if (isset($_GET['id']) && !empty($_GET['id'])) {
        ...
        $checkStudents = $bd->prepare('SELECT * FROM etudiant WHERE id = ?');
        $checkStudents->execute(array($_GET['id']));
        ...
        <div class="content">
            <div class="item">
                <div class="label">
                    ...
                    <p id="name">
                        <?= $etudiant['prenom'].' '.$etudiant['nom'].'_'.$etudiant['matricule'] ?>
                    </p>
                </div>
                ...
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="group">
                        ...
                        <input type="number" id="" class="col" placeholder="Entrez le solde de l'etudiant(e)" name="solde" autocomplete="off" required>
                    </div>
                    <br>
