...
<style>  
    ...
    .col.other .photo{
        width: 200px;
        height: 200px;
        background: url(<?= $etudiant['photo'] ?>) no-repeat;
    ...
    <section class="home section import">
        <div class="navbar">
            <div class="text">
                ...
                <h2>Remplissez votre formulaire <span style="color: var(--blue); text-transform: capitalize;"><?= $_SESSION['prenom'] ?> <?= $_SESSION['nom'] ?></span></span></h2>
            </div>
                        ...
                        ?>
                            <li>
                                <a href="./import.html">
                                    ...
                                    Demande en attente
                                    <div id="notif"><?= $checkCandid->rowCount() ?></div>
                                </a>
                            </li>
                            <li>
                                <a href="./list.php?statut=en_attente" id="<?php if (isset($_GET['statut'])) { if ($_GET['statut'] == 'en_attente') { echo 'active';}} ?>">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-patch-exclamation" viewBox="0 0 16 16">
                                        <path d="M7.001 11a1 1 0 1 1 2 0 1 1 0 0 1-2 0zM7.1 4.995a.905.905 0 1 1 1.8 0l-.35 3.507a.553.553 0 0 1-1.1 0z"/>
                                        <path d="m10.273 2.513-.921-.944.715-.698.622.637.89-.011a2.89 2.89 0 0 1 2.924 2.924l-.01.89.636.622a2.89 2.89 0 0 1 0 4.134l-.637.622.011.89a2.89 2.89 0 0 1-2.924 2.924l-.89-.01-.622.636a2.89 2.89 0 0 1-4.134 0l-.622-.637-.89.011a2.89 2.89 0 0 1-2.924-2.924l.01-.89-.636-.622a2.89 2.89 0 0 1 0-4.134l.637-.622-.011-.89a2.89 2.89 0 0 1 2.924-2.924l.89.01.622-.636a2.89 2.89 0 0 1 4.134 0l-.715.698a1.89 1.89 0 0 0-2.704 0l-.92.944-1.32-.016a1.89 1.89 0 0 0-1.911 1.912l.016 1.318-.944.921a1.89 1.89 0 0 0 0 2.704l.944.92-.016 1.32a1.89 1.89 0 0 0 1.912 1.911l1.318-.016.921.944a1.89 1.89 0 0 0 2.704 0l.92-.944 1.32.016a1.89 1.89 0 0 0 1.911-1.912l-.016-1.318.944-.921a1.89 1.89 0 0 0 0-2.704l-.944-.92.016-1.32a1.89 1.89 0 0 0-1.912-1.911l-1.318.016z"/>
                                    </svg>
                            ...
                            <li>
                                <a href="./list.php?statut=suspendu" id="<?php if (isset($_GET['statut'])) { if ($_GET['statut'] == 'suspendu') { echo 'active';}} ?>">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-patch-exclamation" viewBox="0 0 16 16">
                                        <path d="M7.001 11a1 1 0 1 1 2 0 1 1 0 0 1-2 0zM7.1 4.995a.905.905 0 1 1 1.8 0l-.35 3.507a.553.553 0 0 1-1.1 0z"/>
                                        <path d="m10.273 2.513-.921-.944.715-.698.622.637.89-.011a2.89 2.89 0 0 1 2.924 2.924l-.01.89.636.622a2.89 2.89 0 0 1 0 4.134l-.637.622.011.89a2.89 2.89 0 0 1-2.924 2.924l-.89-.01-.622.636a2.89 2.89 0 0 1-4.134 0l-.622-.637-.89.011a2.89 2.89 0 0 1-2.924-2.924l.01-.89-.636-.622a2.89 2.89 0 0 1 0-4.134l.637-.622-.011-.89a2.89 2.89 0 0 1 2.924-2.924l.89.01.622-.636a2.89 2.89 0 0 1 4.134 0l-.715.698a1.89 1.89 0 0 0-2.704 0l-.92.944-1.32-.016a1.89 1.89 0 0 0-1.911 1.912l.016 1.318-.944.921a1.89 1.89 0 0 0 0 2.704l.944.92-.016 1.32a1.89 1.89 0 0 0 1.912 1.911l1.318-.016.921.944a1.89 1.89 0 0 0 2.704 0l.92-.944 1.32.016a1.89 1.89 0 0 0 1.911-1.912l-.016-1.318.944-.921a1.89 1.89 0 0 0 0-2.704l-.944-.92.016-1.32a1.89 1.89 0 0 0-1.912-1.911l-1.318.016z"/>
                                    </svg>
        ...
        <div class="content">
            <div class="item">
                ...
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <input type="email" placeholder="Entrez votre email" name="email" class="col" required value="<?php echo $email = (isset($_GET['update'])) ? $etudiant['email'] : '';  ?>">
                    <div class="row">
                        <input type="text" placeholder="Commune d'habitation" name="commune" class="col" required value="<?php echo $phone = (isset($_GET['update'])) ? $etudiant['commune'] : '';  ?>">
                        <input type="text" placeholder="Quartier d'habitation" name="quartier" class="col" required value="<?php echo $phone_2 = (isset($_GET['update'])) ? $etudiant['quartier'] : '';  ?>">
                    </div>
                    <div class="row">
                        <input type="text" placeholder="Téléphone 1" name="phone" class="col" required value="<?php echo $phone = (isset($_GET['update'])) ? $etudiant['phone'] : '';  ?>">
                        <input type="text" placeholder="Téléphone 2" name="phone2" class="col" required value="<?php echo $phone_2 = (isset($_GET['update'])) ? $etudiant['phone_2'] : '';  ?>">
                    </div>
                    <div class="row">
                        <input type="text" placeholder="Dernier diplôme" name="diplome" class="col" required value="<?php echo $diplome = (isset($_GET['update'])) ? $etudiant['diplome'] : '';  ?>">
                        <input type="text" placeholder="Date d'obtention" name="date_diplome" class="col" required value="<?php echo $date_diplome = (isset($_GET['update'])) ? $etudiant['date_diplome'] : '';  ?>">
                        <input type="text" placeholder="Etablissement" name="etablissement_diplome" class="col" required value="<?php echo $etablissement = (isset($_GET['update'])) ? $etudiant['etablissement'] : '';  ?>">
                    </div>
                    
                    <hr style="margin:20px 0;">
                    <p class="baseline" style="text-align:left; ">Choisir (03) communes de préférence pour le stage</p>
                    <br>
                    <div class="row">
                        ...
                        <select id="" class="col" name="commune_1" required>
                            <option value="">Sélectionnez une Commune 1</option>
                            <option value="abobo" <?php echo $commune_1 = ($etudiant['commune_1'] == "abobo" && isset($_GET['update'])) ? 'selected' : ''; ?>>Abobo</option>
                            <option value="adjame" <?php echo $commune_1 = ($etudiant['commune_1'] == "adjame" && isset($_GET['update'])) ? 'selected' : ''; ?>>Adjamé</option>
                            <option value="attecoube" <?php echo $commune_1 = ($etudiant['commune_1'] == "attecoube" && isset($_GET['update'])) ? 'selected' : ''; ?>>Attécoubé</option>
                            <option value="cocody" <?php echo $commune_1 = ($etudiant['commune_1'] == "cocody" && isset($_GET['update'])) ? 'selected' : ''; ?>>Cocody</option>
                            <option value="koumassi" <?php echo $commune_1 = ($etudiant['commune_1'] == "koumassi" && isset($_GET['update'])) ? 'selected' : ''; ?>>Koumassi</option>
                            <option value="marcory" <?php echo $commune_1 = ($etudiant['commune_1'] == "marcory" && isset($_GET['update'])) ? 'selected' : ''; ?>>Marcory</option>
                            <option value="plateau" <?php echo $commune_1 = ($etudiant['commune_1'] == "abobo" && isset($_GET['update'])) ? 'selected' : ''; ?>>Plateau</option>
                            <option value="port-bouet" <?php echo $commune_1 = ($etudiant['commune_1'] == "plateau" && isset($_GET['update'])) ? 'selected' : ''; ?>>Port-Bouët</option>
                            <option value="treichville" <?php echo $commune_1 = ($etudiant['commune_1'] == "treichville" && isset($_GET['update'])) ? 'selected' : ''; ?>>Treichville</option>
                            <option value="yopougon" <?php echo $commune_1 = ($etudiant['commune_1'] == "yopougon" && isset($_GET['update'])) ? 'selected' : ''; ?>>Yopougon</option>
                            <option value="songon" <?php echo $commune_1 = ($etudiant['commune_1'] == "songon" && isset($_GET['update'])) ? 'selected' : ''; ?>>Songon</option>
                            <option value="bingerville" <?php echo $commune_1 = ($etudiant['commune_1'] == "bingerville" && isset($_GET['update'])) ? 'selected' : ''; ?>>Bingerville</option>
                        </select>
                        <select id="" class="col" name="commune_2" required>
                            <option value="">Sélectionnez une Commune 2</option>
                            <option value="abobo" <?php echo $commune_2 = ($etudiant['commune_2'] == "abobo" && isset($_GET['update'])) ? 'selected' : ''; ?>>Abobo</option>
                            <option value="adjame" <?php echo $commune_2 = ($etudiant['commune_2'] == "adjame" && isset($_GET['update'])) ? 'selected' : ''; ?>>Adjamé</option>
                            <option value="attecoube" <?php echo $commune_2 = ($etudiant['commune_2'] == "attecoube" && isset($_GET['update'])) ? 'selected' : ''; ?>>Attécoubé</option>
                            <option value="cocody" <?php echo $commune_2 = ($etudiant['commune_2'] == "cocody" && isset($_GET['update'])) ? 'selected' : ''; ?>>Cocody</option>
                            <option value="koumassi" <?php echo $commune_2 = ($etudiant['commune_2'] == "koumassi" && isset($_GET['update'])) ? 'selected' : ''; ?>>Koumassi</option>
                            <option value="marcory" <?php echo $commune_2 = ($etudiant['commune_2'] == "marcory" && isset($_GET['update'])) ? 'selected' : ''; ?>>Marcory</option>
                            <option value="plateau" <?php echo $commune_2 = ($etudiant['commune_2'] == "abobo" && isset($_GET['update'])) ? 'selected' : ''; ?>>Plateau</option>
                            <option value="port-bouet" <?php echo $commune_2 = ($etudiant['commune_2'] == "plateau" && isset($_GET['update'])) ? 'selected' : ''; ?>>Port-Bouët</option>
                            <option value="treichville" <?php echo $commune_2 = ($etudiant['commune_2'] == "treichville" && isset($_GET['update'])) ? 'selected' : ''; ?>>Treichville</option>
                            <option value="yopougon" <?php echo $commune_2 = ($etudiant['commune_2'] == "yopougon" && isset($_GET['update'])) ? 'selected' : ''; ?>>Yopougon</option>
                            <option value="songon" <?php echo $commune_2 = ($etudiant['commune_2'] == "songon" && isset($_GET['update'])) ? 'selected' : ''; ?>>Songon</option>
                            <option value="bingerville" <?php echo $commune_2 = ($etudiant['commune_2'] == "bingerville" && isset($_GET['update'])) ? 'selected' : ''; ?>>Bingerville</option>
                        </select>
                        <select id="" class="col" name="commune_3" required>
                            <option value="">Sélectionnez une Commune 3</option>
                            <option value="abobo" <?php echo $commune_3 = ($etudiant['commune_3'] == "abobo" && isset($_GET['update'])) ? 'selected' : ''; ?>>Abobo</option>
                            <option value="adjame" <?php echo $commune_3 = ($etudiant['commune_3'] == "adjame" && isset($_GET['update'])) ? 'selected' : ''; ?>>Adjamé</option>
                            <option value="attecoube" <?php echo $commune_3 = ($etudiant['commune_3'] == "attecoube" && isset($_GET['update'])) ? 'selected' : ''; ?>>Attécoubé</option>
                            <option value="cocody" <?php echo $commune_3 = ($etudiant['commune_3'] == "cocody" && isset($_GET['update'])) ? 'selected' : ''; ?>>Cocody</option>
                            <option value="koumassi" <?php echo $commune_3 = ($etudiant['commune_3'] == "koumassi" && isset($_GET['update'])) ? 'selected' : ''; ?>>Koumassi</option>
                            <option value="marcory" <?php echo $commune_3 = ($etudiant['commune_3'] == "marcory" && isset($_GET['update'])) ? 'selected' : ''; ?>>Marcory</option>
                            <option value="plateau" <?php echo $commune_3 = ($etudiant['commune_3'] == "abobo" && isset($_GET['update'])) ? 'selected' : ''; ?>>Plateau</option>
                            <option value="port-bouet" <?php echo $commune_3 = ($etudiant['commune_3'] == "plateau" && isset($_GET['update'])) ? 'selected' : ''; ?>>Port-Bouët</option>
                            <option value="treichville" <?php echo $commune_3 = ($etudiant['commune_3'] == "treichville" && isset($_GET['update'])) ? 'selected' : ''; ?>>Treichville</option>
                            <option value="yopougon" <?php echo $commune_3 = ($etudiant['commune_3'] == "yopougon" && isset($_GET['update'])) ? 'selected' : ''; ?>>Yopougon</option>
                            <option value="songon" <?php echo $commune_3 = ($etudiant['commune_3'] == "songon" && isset($_GET['update'])) ? 'selected' : ''; ?>>Songon</option>
                            <option value="bingerville" <?php echo $commune_3 = ($etudiant['commune_3'] == "bingerville" && isset($_GET['update'])) ? 'selected' : ''; ?>>Bingerville</option>
                        </select>
                    </div>
                    <hr style="margin:20px 0;">
                    <div class="row">
                        <div class="col other">
                            ...
                            <?php
                                ...
                                if ($checkCandidates->rowCount() < 0 || isset($_GET['update']) || isset($_GET['new'])) {
                                    ?>
                                        
                                        <input type="file" accept="image/*" name="photo" class="col" required value="<?php echo $photo = (isset($_GET['update'])) ? $etudiant['photo'] : '';  ?>">
                                    <?php
                                }
                            ?>
                            ...
                            <?php
                                ...
                                if ($checkCandidates->rowCount() > 0 &&  !isset($_GET['update']) &&  isset($_GET['ask'])) {
                                    ?>
                                        <div class="photo">
                        ...
                        <div class="col other" style="background: transparent;">
                            ...
                            if ($checkCandidates->rowCount() < 0 || isset($_GET['update']) || isset($_GET['new'])) {
                                ?>
                                    ...
                                    <input type="file" accept=".pdf" name="cv" class="col" value="<?php echo $cv = (isset($_GET['update'])) ? $etudiant['cv'] : '';  ?>" required>
                    ...
                    if ($checkCandidates->rowCount() < 0 || isset($_GET['update']) || isset($_GET['new'])) {
                        ?>
                            <button type="submit" class="btn" id="importation" name="submit">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-journal-check" viewBox="0 0 16 16">
                                    <path fill-rule="evenodd" d="M10.854 6.146a.5.5 0 0 1 0 .708l-3 3a.5.5 0 0 1-.708 0l-1.5-1.5a.5.5 0 1 1 .708-.708L7.5 8.793l2.646-2.647a.5.5 0 0 1 .708 0z"/>
                                    <path d="M3 0h10a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2v-1h1v1a1 1 0 0 0 1 1h10a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1H3a1 1 0 0 0-1 1v1H1V2a2 2 0 0 1 2-2"/>
                                    <path d="M1 5v-.5a.5.5 0 0 1 1 0V5h.5a.5.5 0 0 1 0 1h-2a.5.5 0 0 1 0-1zm0 3v-.5a.5.5 0 0 1 1 0V8h.5a.5.5 0 0 1 0 1h-2a.5.5 0 0 1 0-1zm0 3v-.5a.5.5 0 0 1 1 0v.5h.5a.5.5 0 0 1 0 1h-2a.5.5 0 0 1 0-1z"/>
